...
class Restaurante extends Component {
    ...
    delAtractivo() {
        fetch(`${process.env.REACT_APP_API_HOST}/gastronomia/${this.state.idDelete}`, {
            method: 'DELETE',
            headers: {
    ...
    saveAtractivo() {
        fetch(`${process.env.REACT_APP_API_HOST}/gastronomia/${this.state.atractivo.id}`, {
            method: 'PATCH',
            headers: {
                "Authorization": "asdssffsdff",
                "Content-Type": "application/json"
    ...
    componentDidMount() {
        ...
        fetch(`${process.env.REACT_APP_API_HOST}/gastronomia/${this.props.idAtractivo}`, {
            method: "GET",
            headers: {
                "Authorization": "asdssffsdff",
