...
class Atractivo extends Component {
  ...
  DelAudioAtractivo(id) {
    fetch(
      `${process.env.REACT_APP_API_HOST}/atractivo/DelAudio/${this.state.id}`,
      {
        method: "DELETE",
        headers: {
  ...
  setLatLng() {
    let LatLng = ddToDms(
      this.state.atractivo.latitud,
      this.state.atractivo.longitud
    );
    this.setState({
      atractivo: {
        ...this.state.atractivo,
  ...
  saveAtractivo(event) {
    ...
    let file_uno = document.getElementById(`file-${this.state.atractivo.id}`)
      .files[0];
    if (file_uno) {
    ...
    fetch(
      `${process.env.REACT_APP_API_HOST}/atractivo/${this.props.idAtractivo}`,
      {
        method: "POST",
        headers: {
          Authorization: "",
          ...
          <React.Fragment>
            <div className="card">
              <div
                ...
                id={`atractivo-${this.state.atractivo.id}`}
              >
                <h5 className="mb-0 d-flex justify-content-between">
                  <button
                    ...
                    data-target={`#collapse-activo-${this.state.atractivo.id}`}
                    aria-expanded="true"
                    aria-controls={`collapse-activo-${this.state.atractivo.id}`}
                    onClick={(e) => {
              ...
              <div
                id={`collapse-activo-${this.state.atractivo.id}`}
                className="collapse"
                aria-labelledby={`atractivo-${this.state.atractivo.id}`}
                    ...
                    <div className="col-sm-12 col-md-6">
                        ...
                        <div className="col">
                          ...
                          <div className="form-group">
                            ...
                            {this.state.atractivo.descripcionHTML == "" ? (
                              <MyEditor
                                descripcionHTML={
                                  this.handlDescripcionHTMLChange
                                }
                        ...
                        <div className="col">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              id="domicilio"
                              className="form-control"
                              value={this.state.atractivo.domicilio}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </div>
                        ...
                        <div className="col-sm-12 col-md-6">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              id="latitud"
                              className="form-control"
                              value={this.state.atractivo.latitud}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </div>
                        ...
                        <div className="col-sm-12 col-md-6">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              id="longitud"
                              className="form-control"
                              value={this.state.atractivo.longitud}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </div>
                        ...
                        <div className="col-sm-12 col-md-6">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              id="latitudg"
                              className="form-control"
                              value={this.state.atractivo.latitudg}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </div>
                        ...
                        <div className="col-sm-12 col-md-6">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              id="longitudg"
                              className="form-control"
                              value={this.state.atractivo.longitudg}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </div>
                      ...
                      <div className="row">
                        <div className="col-sm-12 col-md-4">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              id="telefono"
                              className="form-control"
                              value={this.state.atractivo.telefono}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </div>
                        ...
                        <div className="col-sm-12 col-md-4">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              id="costo"
                              className="form-control"
                              value={this.state.atractivo.costo}
                              onChange={this.handleChange}
                              min={0}
                              autoComplete="off"
                            />
                        ...
                        <div className="col-sm-12 col-md-4 d-flex align-items-center justify-content-center">
                          {this.state.atractivo.imperdible == 0 ? (
                            <div className="form-check">
                              <input
                                ...
                                type="checkbox"
                                value={this.state.atractivo.imperdible}
                                onChange={this.handleChange}
                              />
                              <label
                            ...
                            <div className="form-check">
                              <input
                                ...
                                value={this.state.atractivo.imperdible}
                                onChange={this.handleChange}
                                defaultChecked={this.state.atractivo.imperdible} // Establece el valor "defaultChecked"
                              />
                              <label
                                className="form-check-label"
                                htmlFor="imperdible"
                        ...
                        <div className="col">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              id="mail"
                              className="form-control"
                              value={this.state.atractivo.mail}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </div>
                          <div className="form-group">
                            ...
                            <input
                              ...
                              id="web"
                              className="form-control"
                              value={this.state.atractivo.web}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </div>
                    ...
                    <div className="col-sm-12 col-md-6">
                      <div className="row mb-3">
                        <div className="col-sm-12 col-md-12">
                          <span className="bg-dark text-white p-2 rounded d-block">
                            Horarios
                          </span>
                        </div>
                      </div>
                        ...
                        <div className="col">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              id="lunes"
                              className="form-control"
                              value={this.state.atractivo.lunes}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </div>
                          <div className="form-group">
                            ...
                            <input
                              ...
                              id="martes"
                              className="form-control"
                              value={this.state.atractivo.martes}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </div>
                          <div className="form-group">
                            ...
                            <input
                              ...
                              id="miercoles"
                              className="form-control"
                              value={this.state.atractivo.miercoles}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </div>
                          <div className="form-group">
                            ...
                            <input
                              ...
                              id="jueves"
                              className="form-control"
                              value={this.state.atractivo.jueves}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </div>
                          <div className="form-group">
                            ...
                            <input
                              ...
                              id="viernes"
                              className="form-control"
                              value={this.state.atractivo.viernes}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </div>
                          <div className="form-group">
                            ...
                            <input
                              ...
                              id="sabado"
                              className="form-control"
                              value={this.state.atractivo.sabado}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </div>
                          <div className="form-group">
                            ...
                            <input
                              ...
                              id="domingo"
                              className="form-control"
                              value={this.state.atractivo.domingo}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </div>
                          {this.state.atractivo.activo == 0 ? (
                            <div className="form-check">
                              <input
                                name="activo"
                                id="activo"
                                className="form-check-input"
                                type="checkbox"
                                value={this.state.atractivo.activo}
                                onChange={this.handleChange}
                              />
                              <label
                                className="form-check-label"
                            ...
                            <div className="form-check">
                              <input
                                ...
                                value={this.state.atractivo.activo}
                                onChange={this.handleChange}
                                defaultChecked={this.state.atractivo.activo} // Establece el valor "defaultChecked"
                              />
                              <label
                                className="form-check-label"
                                htmlFor="activo"
                          ...
                          <div className="form-group">
                            <label htmlFor={`file-${this.state.atractivo.id}`}>
                              Audio para Turismo Dark
                            </label>
                            <br />
                            <input
                              type="file"
                              name={`file-${this.state.atractivo.id}`}
                              id={`file-${
                                this.state.atractivo.id
            ...
            <Msg
              visible={this.state.Msg.MsgVisible}
              okClose={() =>
                this.setState({ Msg: { ...this.state.Msg, MsgVisible: false } })
              }
              okAceptar={this.delAtractivo}
              tipo={this.state.Msg.MsgTipo}
            >
