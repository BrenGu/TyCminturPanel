...
class Restaurante extends Component {
  ...
  delAtractivo() {
    fetch(
      `${process.env.REACT_APP_API_HOST}/gastronomia/${this.state.idDelete}`,
      {
        method: "DELETE",
        headers: {
  ...
  saveAtractivo() {
    //console.log(this.state.atractivo);
    fetch(
      `${process.env.REACT_APP_API_HOST}/gastronomia/${
      ...
      .then(
        (result) => {
          //console.log("atractivo restaurante: " + result);
          if (!result.err) {
    ...
    alert("Los Datos de han guardado Correctamente ");
  }
  ...
  componentDidMount() {
    ...
    fetch(
      `${process.env.REACT_APP_API_HOST}/gastronomiaNoFotos/${
        this.props.idAtractivo
      }`,
      {
        method: "GET",
        headers: {
                        ...
                        <div className="col">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              value={this.state.atractivo.tipo}
                          ...
                          <div className="form-check">
                            {this.state.atractivo.imperdible >= 1 ? (
                              <input
                                ...
                                onChange={this.handleChange}
                                checked={
                                  this.state.atractivo.imperdible
                                    ? "checked"
                                    : false
                                }
                              />
                          ...
                          <div className="form-check">
                            {this.state.atractivo.adhiereDosep >= 1 ? (
                              <input
                                ...
                                id="adhiereDosep"
                                className="form-check-input"
                                value={this.state.atractivo.adhiereDosep}
                                onChange={this.handleChange}
                                checked={
                                  this.state.atractivo.adhiereDosep
                                    ? "checked"
                                    : false
                                }
                              />
