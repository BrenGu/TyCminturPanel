...
class FormAlquilerAutos extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: true,
  ...
  saveData(event) {
    ...
    fetch(`${process.env.REACT_APP_API_HOST}/updatealquilerauto/${this.state.id}`, {
      method: "POST",
      headers: {
  ...
  setData() {
    ...
    this.setState(
      ...
      () => {
        fetch(
          `${process.env.REACT_APP_API_HOST}/alquilerauto/${this.state.id}`,
          {
            method: "GET",
            headers: {
              Authorization: token
                  ...
                  <div className="col">
                    <div className="d-flex justify-content-end">
                      {/* <button
                        ...
                        onClick={(e) => { this.askDelete(this.state.registro.nombre, e) }
                        }
                      >
...
FormAlquilerAutos.contextType = Consumer;

export default FormAlquilerAutos;
