...
class Eventos extends Component {
  ...
  handleFormEveSubmit(event) {
    console.log(this.state.evento.descripcionHTML);
    ...
    data.append("descripcionHTML", this.state.evento.descripcionHTML);
    ...
    data.append("destacado", this.state.evento.destacado);
  ...
  resetForm() {
    ...
    document
      .getElementById("img-upl-eve-uno")
      .setAttribute(
        "src",
    ...
    document
      .getElementById("img-upl-eve-dos")
      .setAttribute(
        "src",
        `${process.env.REACT_APP_API_HOST}/${
          process.env.REACT_APP_API_DIRECTORY_EVENTOS_FOTOS
        ...
        {this.state.loading ? (
          ...
          <React.Fragment>
            <h4 className="bg-info text-white p-3 mb-3 rounded animated bounceInLeft delay-2s">
              <i className="fas fa-newspaper" /> Eventos
            </h4>
            <form
              method="post"
              onSubmit={this.handleFormEveSubmit}
              id="frm-eventos"
            >
              <div className="grid-eventos">
                <div className="eventos-span-row-2">
                  <div className="row">
                    <div className="col-md-12">
                      <div className="form-group">
                        ...
                        <select
                          ...
                          value={this.state.evento.idlocalidad}
                    ...
                    <div className="col-md-12">
                      <div className="form-group">
                        ...
                        <input
                          ...
                          id="direccion"
                          className="form-control"
                          value={this.state.evento.direccion}
                          onChange={this.handleInputChange}
                          maxLength="100"
                        />
                      </div>
                    ...
                    <div className="col-md-12">
                      <div className="form-group">
                        ...
                        <input
                          ...
                          id="invita"
                          className="form-control"
                          value={this.state.evento.invita}
                          onChange={this.handleInputChange}
                          maxLength="100"
                    ...
                    <div className="col-md-12">
                      <div className="form-group">
                        ...
                        <input
                          ...
                          id="organiza"
                          className="form-control"
                          value={this.state.evento.organiza}
                          onChange={this.handleInputChange}
                          maxLength="100"
                    ...
                    <div className="col-md-6">
                      <div className="form-group">
                        ...
                        <input
                          ...
                          id="dfecha"
                          className="form-control"
                          value={this.state.evento.dfecha}
                          onChange={this.handleInputChange}
                        />
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="form-group">
                        ...
                        <input
                          ...
                          id="hfecha"
                          className="form-control"
                          value={this.state.evento.hfecha}
                          onChange={this.handleInputChange}
                        />
                      </div>
                    </div>
                    ...
                    <div className="col-md-4">
                      <div className="form-group">
                        <label htmlFor="costo">destacado</label>
                        <input
                          type="text"
                          name="destacado"
                          id="destacado"
                          className="form-control"
                          value={this.state.evento.destacado}
                          onChange={this.handleInputChange}
                        />
                      </div>
                    </div>
                    ...
                    <div className="d-flex">
                      <div className="col">
                        ...
                        <img
                          ...
                          alt="Foto"
                          onClick={(e) => {
                            document.getElementById("upl-eve-uno").click();
                          }}
                        />
                      </div>
                      <div className="col">
                        ...
                        <img
                          ...
                          src={`${process.env.REACT_APP_API_HOST}/${
                            process.env.REACT_APP_API_DIRECTORY_EVENTOS_FOTOS
                          }/${this.state.evento.foto_dos}`}
                          alt="Foto"
                          onClick={(e) => {
                            document.getElementById("upl-eve-dos").click();
                          }}
                        />
                      </div>
                    </div>
                ...
                <div className="col">
                  <div className="d-flex justify-content-between">
                    ...
                    <button type="submit" className="btn btn-primary">
                      <i className="fas fa-arrow-down" /> Agregar Evento
                    </button>
                  </div>
                </div>
              </div>
