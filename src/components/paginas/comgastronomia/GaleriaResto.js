...
class GaleriaResto extends Component {
    constructor(props) {
        super(props);
        this.state = {
            loading: true,
    ...
    handleImgChange = (event) => {
        ...
        fetch(`${process.env.REACT_APP_API_HOST}/gastronomia/${this.state.idAtractivo}/imagen`, {
            method: "POST",
            headers: {
    ...
    askDelete = (id, imagen, e) => {
        fetch(`${process.env.REACT_APP_API_HOST}/gastronomia/imagen/${id}`, {
            method: "DELETE",
            headers: {
    ...
    findGalery = () => {
        fetch(`${process.env.REACT_APP_API_HOST}/gastronomia/${this.state.idAtractivo}/imagenes`, {
            method: "GET",
            headers: {
                "Authorization": "asdssffsdff",
                //"Content-Type": "multipart/form-data"
